...
var CoreSelectView = react_1.default.forwardRef(function (props, ref) {
    ...
    var _f = __read((0, react_1.useState)(), 2), compositionText = _f[0], setCompositionText = _f[1];
    ...
    var renderedValuePlain = typeof renderedValue === 'string' || typeof renderedValue === 'number'
